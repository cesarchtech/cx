...
<html>
	  ...
	  $(document).ready(function(){
		$('#buscar').click(function(){
		   ...
		   $.ajax({ //FILTRA OS RELATORIOS COM BASE NAS INFORMAÇOES SELECIONADAS.
				url: 'filtrarelatorios1.php?diade='+ $('select#diade').val()+'&diaate='+ $("select[name='diaate']").val() +'&mesde=' + $("select[name='mesde']").val() +'&mesate='+ $("select[name='mesate']").val() +'&anode='+ $("select[name='anode']").val()+'&anoate='+ $("select[name='anoate']").val()+'&conta='+ $("select[name='conta']").val()+'&tipo='+ $("select[name='tipo']").val()+'&modo='+ $("select[name='modo']").val()+'&busca='+ $("input[name='busca']").val(),
				type: 'GET',
					dataType: 'html',
	...
	$(document).ready(function(){
		...
		$("select[name='mesate']").change(function(){			
			...
			//});
				$.ajax({ //FILTRA OS RELATORIOS COM BASE NAS INFORMAÇOES SELECIONADAS.
				url: 'filtrarelatorios1.php?diade='+ $("select[name='diade']").val()+'&diaate='+ $('select#diaate').html(data).val()+'&mesde=' + $("select[name='mesde']").val() +'&mesate='+ $("select[name='mesate']").val() +'&anode='+ $("select[name='anode']").val()+'&anoate='+ $("select[name='anoate']").val()+'&conta='+ $("select[name='conta']").val()+'&tipo='+ $("select[name='tipo']").val()+'&modo='+ $("select[name='modo']").val()+'&busca='+ $("input[name='busca']").val(),
				type: 'GET',
					dataType: 'html',
					success: function (data) {
						$('div#tabela').html(data);
		...
		$("select[name='anode']").change(function(){	
			...
			/*$.ajax({
				url: 'filtrarelatorios1.php?mes=' + $("select[name='mesde']").val()+'&anode='+$(this).val()+'&conta='+ $("select[name='conta']").val()+'&tipo='+ $("select[name='tipo']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#tabela').html(data);
		...
		$("select[name='tipo']").change(function(){			
			$.ajax({ //FILTRA OS RELATORIOS COM BASE NAS INFORMAÇOES SELECIONADAS.
				url: 'filtrarelatorios1.php?diade='+ $("select[name='diade']").val()+'&diaate='+ $("select[name='diaate']").val()+'&mesde=' + $("select[name='mesde']").val() +'&mesate='+ $("select[name='mesate']").val()+'&anode='+ $("select[name='anode']").val()+'&anoate='+ $("select[name='anoate']").val()+'&conta='+ $("select[name='conta']").val()+'&tipo='+ $(this).val()+'&modo='+ $("select[name='modo']").val()+'&busca='+ $("input[name='busca']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#tabela').html(data);
		...
		$.ajax({
				url: 'filtrarelatorios1.php?diade='+ $("select[name='diade']").val()+'&diaate='+ $("select[name='diaate']").val()+'&mesde=' + $("select[name='mesde']").val() +'&mesate='+ $("select[name='mesate']").val()+'&anode='+ $("select[name='anode']").val()+'&anoate='+ $("select[name='anoate']").val()+'&conta='+ $("select[name='conta']").val()+'&tipo='+ $("select[name='tipo']").val()+'&modo='+ $("select[name='modo']").val()+'&busca='+ $("input[name='busca']").val(),
	//			url: 'filtrarelatorios1.php?mes=' + $("select[name='mes']").val() +'&ano='+ $("select[name='ano']").val()+'&conta='+ $("select[name='conta']").val()+'&tipo='+ $("select[name='tipo']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#tabela').html(data);
