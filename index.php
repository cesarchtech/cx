...
<html>
	...
	//MÊS		
    if (localStorage.getItem("select[name='mes']")) {
        $("select[name='mes'] option").eq(localStorage.getItem("select[name='mes']")).prop('selected', true);
    }
	//ANO		
    if (localStorage.getItem("select[name='ano']")) {
        $("select[name='ano'] option").eq(localStorage.getItem("select[name='ano']")).prop('selected', true);
    }
	//CONTA
    ...
    $("select[name='mes']").on('change', function() {
        localStorage.setItem("select[name='mes']", $('option:selected', this).index());
		});
	//ANO
    $("select[name='ano']").on('change', function() {
        localStorage.setItem("select[name='ano']", $('option:selected', this).index());
		});
	});
	...
	$(document).ready(function(){
		$("select[name='conta']").change(function(){			
			$.ajax({
				url: 'filtrafluxo.php?mes='+$("select[name='mes']").val()+'&ano='+$("select[name='ano']").val()+'&conta='+$(this).val()+'&origem='+ $("select[name='origem']").val(),
				type: 'GET',
				dataType: 'html',
		...
		$("select[name='mes']").change(function(){			
			$.ajax({
				url: 'filtrafluxo.php?mes='+$(this).val()+'&ano='+$("select[name='ano']").val()+'&conta='+$("select[name='conta']").val()+'&origem='+$("select[name='origem']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#tabela').html(data);
		...
		$("select[name='ano']").change(function(){			
			$.ajax({
				url: 'filtrafluxo.php?mes='+$("select[name='mes']").val()+'&ano='+$(this).val()+'&conta='+$("select[name='conta']").val()+'&origem='+$("select[name='origem']").val(),
				//url: 'filtrafluxo.php?mes='+$(this).val()+'&ano='+$("select[name='ano']").val()+'&conta='+$("select[name='conta']").val()+'&origem='+$("select[name='origem']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
		...
		$("select[name='origem']").change(function(){			
			$.ajax({
				url: 'filtrafluxo.php?mes='+$("select[name='mes']").val()+'&ano='+$("select[name='ano']").val()+'&conta='+$("select[name='conta']").val()+'&origem='+$(this).val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#tabela').html(data);
		...
		$.ajax({
				url: 'filtrafluxo.php?mes=' + $("select[name='mes']").val() +'&ano='+ $("select[name='ano']").val()+'&conta='+ $("select[name='conta']").val()+'&origem='+$("select[name='origem']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#tabela').html(data);
