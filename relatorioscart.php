...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js" ></script>	
	<script type="text/javascript">	
		$("select[name='mes']").change(function(){			
			$.ajax({
				url: 'filtrarelatcart.php?mes=' + $(this).val()+'&ano='+ $("select[name='ano']").val(),
		...
		$("select[name='ano']").change(function(){			
			$.ajax({
				url: 'filtrarelatcart.php?mes=' + $("select[name='mes']").val()+'&ano='+$(this).val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#dados').html(data);
		...
		$.ajax({
				url: 'filtrarelatcart.php?mes=' + $("select[name='mes']").val() +'&ano='+ $("select[name='ano']").val(),
				type: 'GET',
				dataType: 'html',
				success: function (data) {
					$('div#dados').html(data);
	...
	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js" ></script>	
		...
		function mstTabela(tipo) {
			var tip = tipo;
			$.ajax({
					url: 'filtrarelatcarttabela.php?mes=' + $("select[name='mes']").val()+'&ano='+ $("select[name='ano']").val()+'&tipo='+ tip,
					type: 'GET',
					dataType: 'html',
					success: function (data) {
